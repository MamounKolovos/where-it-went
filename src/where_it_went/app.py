...
from where_it_went.service.usa_spending import (Award, SpendingResponse, USASpendingClient)
...
def generate_summary():
    try:
        ...
        match summary_result:
            ...
            case Err(error):
                return jsonify({"summary": f"Unable to generate summary: {error}"}), HTTPStatus.INTERNAL_SERVER_ERROR
